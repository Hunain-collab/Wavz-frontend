  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 text-white">
      ...
      <button
        ...
        className="flex w-full items-center justify-center space-x-2 rounded-2xl bg-[#FE9216] py-3 text-lg font-semibold text-white transition-colors hover:bg-[#e68312] disabled:cursor-not-allowed disabled:opacity-50"
      >
        {isSubmitting ? (
          <>
